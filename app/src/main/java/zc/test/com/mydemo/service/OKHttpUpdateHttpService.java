package zc.test.com.mydemo.service;
...
public class OKHttpUpdateHttpService implements IUpdateHttpService {
    ...
    private static OKHttpUpdateHttpService instance;

    public static synchronized OKHttpUpdateHttpService getInstance(){
        if (instance == null) {
            instance = new OKHttpUpdateHttpService();
        }
        return instance;
    }
