...
public class CircularImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public CircularImageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        ratio = ta.getFloat(R.styleable.CircularImageView_ratio, 0);
        mBorderRadius = ta.getInteger(R.styleable.CircularImageView_angle, 0);
        imgType = ta.getBoolean(R.styleable.CircularImageView_isCircle, false);
