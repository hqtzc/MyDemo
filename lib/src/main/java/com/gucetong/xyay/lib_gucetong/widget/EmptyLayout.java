package com.gucetong.xyay.lib_gucetong.widget;//package com.gucetong.xyay.gucetong.view.widget;
//
...
////                mRlEmptyContainer.setVisibility(GONE);//重试按钮
////                mEmptyLoading.setVisibility(VISIBLE);//加载布局
////                break;
////            case STATUS_NO_DATA:
////            case STATUS_NO_NET:
////                setVisibility(VISIBLE);
